...
class Script:
    ...
    Attributes:
        ...
        skip_first_execution (bool): Indicates whether the script should skip the first execution 
            when the triggering PVs are set for the first time.
    ...
    def __init__(self, script_path, embed=True, skip_first_execution=False):
        ...
        Args:
            ...
            embed (bool, optional): Indicates whether the script should be embedded into XML. 
                Defaults to True.
            skip_first_execution (bool, optional): Indicates whether the script should skip the 
                first execution when the triggering PVs are set for the first time. Defaults to
                False.
        """
    ...
    def set_name(self, name):
        ...
        By default, the scripts name is the same as its filepath.
        
        Args:
            name (str): Name for the script.
        """
        self.name = name
